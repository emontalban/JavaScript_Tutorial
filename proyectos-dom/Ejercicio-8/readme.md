...
El ejercicio simula un pequeño sistema de mensajes donde el usuario escribe texto en un input y, al pulsar un botón, el mensaje aparece automáticamente dentro de un contenedor.
